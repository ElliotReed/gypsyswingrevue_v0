...
<head>
    ...
    <link rel="SHORTCUT ICON" href="https://list.gypsyswingrevue.com/images/phplist.ico" />
    <title>Subscribe to our Newsletters</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />

    <link rel="apple-touch-icon" href="https://list.gypsyswingrevue.com/images/phplist-touch-icon.png" />
    <link rel="apple-touch-icon-precomposed" href="https://list.gypsyswingrevue.com/images/phplist-touch-icon.png" />
...
'dialog,modal,scrollbars=no,resizable=no,width=550,height=500,left=100,top=100');">
                ...
                <p class="poweredby">
                    <a href="https://www.phplist.com/poweredby?utm_source=pl3.6.6&amp;utm_medium=poweredhostedimg&amp;utm_campaign=phpList" title="visit the phpList website">
                        <img src="https://list.gypsyswingrevue.com/images/power-phplist.png" width="70" height="30" title="powered by phpList version 3.6.15, &copy; phpList ltd" alt="powered by phpList 3.6.6, &copy; phpList ltd" border="0" />
                    </a>
                </p>
            </div>
