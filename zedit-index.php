...
include("views/zedit-header.php");
?>
<?php
...
<div class="row" data-equalizer>
	...
	<div class="medium-6 columns">
      ...
      <a href="/iloveparis"><h5>Gypsy Swing Revue's "I Love Paris!"ft. Kristi Stice</h5></a>
      <div class="flex-video">
...
<!--SCHEDULE-->
<ul class="accordion" data-accordion></ul><!--false call to make accordion work-->
<div id="schedule"></div><!--schedule place holder-->
<script>
	$(function schedule(){
		$("#schedule").html("<i class='fa fa-spinner fa-pulse'></i>").show();
		var type="2weeks";
		var url= "php/schedule-handler.php";
		$.post(url, {contentVar:type},function(data) {
